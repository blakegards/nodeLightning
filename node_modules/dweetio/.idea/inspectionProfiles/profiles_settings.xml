<component name="InspectionProjectProfileManager">
  <settings>
    ...
    <version value="1.0" />
    <info color="3e4eff">
      <option name="BACKGROUND" value="7a81f6" />
      <option name="ERROR_STRIPE_COLOR" value="3e4eff" />
      <option name="myName" value="INCOMPATIBILITY" />
      <option name="myVal" value="50" />
      <option name="myExternalName" value="INCOMPATIBILITY" />
    </info>
    <list size="8">
      <item index="0" class="java.lang.String" itemvalue="INCOMPATIBILITY" />
